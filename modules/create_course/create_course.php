...
if (isset($_POST['create_course'])) {
        ...
        // create directories
        umask(0);
        if (! (mkdir("../../courses/$repertoire", 0700) and
                                mkdir("../../courses/$repertoire/image", 0700) and
                                mkdir("../../courses/$repertoire/document", 0700) and
                                mkdir("../../courses/$repertoire/dropbox", 0700) and
                                mkdir("../../courses/$repertoire/page", 0700) and
                                mkdir("../../courses/$repertoire/work", 0700) and
                                mkdir("../../courses/$repertoire/group", 0700) and
                                mkdir("../../courses/$repertoire/temp", 0700) and
                                mkdir("../../courses/$repertoire/scormPackages", 0700) and
                                mkdir("../../video/$repertoire", 0700))) {
