...
if (isset($_POST['send_archive']) and $_FILES['archiveZipped']['size'] > 0 and isset($_POST['rhh']) and $_POST['rhh']==123) {
	...
	$tool_content .= "<tbody></table><br />";
} elseif (isset($_POST['send_path']) and isset($_POST['pathToArchive']) and isset($_POST['rhh']) and $_POST['rhh']==123) {
...
// -------------------------------------
	...
	<input type='hidden' name='rhh' value='123' />
